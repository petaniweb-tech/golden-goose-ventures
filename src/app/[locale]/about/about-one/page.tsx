  ...
  return (
    <>
      ...
      <div className="container mx-auto px-4 py-16">
        <p>
          Empowering the Future of Blockchain & Crypto Innovation At Golden
          Goose Ventures, we are committed to accelerating the growth of the
          next wave of blockchain and cryptocurrency innovation. As a leading
          venture capital firm in the crypto space, we invest in visionary
          entrepreneurs, groundbreaking protocols, and disruptive technologies
          that redefine the future of finance and digital ownership.
        </p>
        <br />
        <p>
          ...
          exclusive network of partners, developers, and industry leaders. We
          believe in long-term value creation and sustainable growth, investing
          in projects that align with our vision of a decentralized and
          trustless future. Our portfolio companies benefit from our extensive
          experience in liquidity provisioning, regulatory strategy, and global
          market expansion.
        </p>
      </div>
    </>
