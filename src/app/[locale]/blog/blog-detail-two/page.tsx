            ...
            <div className="breadcrumb-block w-full lg:h-[400px] h-[360px] relative">
              ...
              <div className="container relative h-full flex items-center justify-center">
                ...
                <div className="text-nav flex flex-col items-center justify-center xl:w-2/3 lg:w-3/4 sm:w-5/6">
                  <div className="caption2 text-center py-2 px-4 bg-surface rounded-2xl inline-block">
                    {foundPost?.tag || "Design"}
                  </div>
                  <div className="heading4 text-center mt-4 text-white">
                    {foundPost?.title ||
                  ...
                  <div className="date flex items-center justify-center gap-4 mt-4">
                    <div className="author flex items-center gap-4">
                      <Image
                        width={4000}
                        height={4000}
                        className="w-10 h-10 border border-line rounded-full"
                        src={foundPost?.avatar || "/images/member/60x60.png"}
                        alt=""
                      />
                      <span className="text-button text-white">
                        {foundPost?.author || "GGV"}{" "}
                      </span>
                    </div>
                    <div className="space text-3xl font-normal text-white">
                      -
                    </div>
                    <div className="item-date flex items-center">
                      ...
                      />
                      <span className="ml-1 caption2 text-white">
                        {foundPost?.date || "2 days ago"}
                      </span>
                    </div>
                  </div>
                </div>
