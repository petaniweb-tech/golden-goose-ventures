            ...
            >
              <div className="bg-img rounded-xl overflow-hidden">
                <Image
                  width={5000}
                  height={5000}
                  className="w-full h-full rounded-xl block duration-700"
                  src={data.img}
                  alt=""
                />
              </div>
              <div className="infor px-10 text-center -mt-6 relative z-[2]">
                <div className="main-infor bg-white rounded-lg px-6 py-4 box-shadow-sm">
                  <div className="category text-center text-button-uppercase text-secondary">
                    {data.subTitle}
                  </div>
            ...
            <div className="item-main">
              <div className="bg-img rounded-xl overflow-hidden">
                <Image
                  width={5000}
                  height={5000}
                  className="w-full h-full rounded-xl display-block"
                  src={data.img}
                  alt=""
                />
                <Link
          ...
          <div className="case-study-item style-two style-three item-filter">
            <div className="item-main">
              ...
              >
                ...
                <div className="body2 text-secondary capitalize mt-2">
                  {data.subTitle}
                </div>
              </Link>
            </div>
