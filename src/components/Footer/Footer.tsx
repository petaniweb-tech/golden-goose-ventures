              ...
              <div className="company-contact">
                ...
                <div className="mt-3 flex items-center">
                  ...
                  <div className="text ml-16">
                    <div className="caption2 text-white">
                      {t("FOOTER.NEED_HELP") || "Need help? 24/7"}
                    </div>
                    <div className="fw-700 text-white mt-1">
                      {t("FOOTER.PHONE_NUMBER") || "+1 888-345-6789"}
                    </div>
                  </div>
                </div>
                <div className="locate mt-3 flex items-center">
                  <Icon.MapPin weight="light" className="text-white" />
                  <div className="caption1 text-white ml-2">
                    {t("FOOTER.ADDRESS") ||
