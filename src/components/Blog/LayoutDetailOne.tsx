            ...
            {/* <div className="tags-popular-block md:mt-10 mt-6">
              ...
              <div className="list-tag mt-4 flex flex-wrap gap-3">
                {[
                  ...
                  <div
                    key={item}
                    className={`caption2 py-2 px-4 bg-surface rounded-2xl hover:bg-black hover:text-white duration-300 cursor-pointer ${
                      item === tag ? "active" : ""
                    }`}
            ...
            <div className="blog-paragraph">
              <div className="paragraph-heading">
                ...
                <div className="date flex items-center gap-4 mt-4">
                  <div className="author caption2 text-secondary">
                    by{" "}
                    <span className="text-black">{data?.author || "GGV"} </span>
                  </div>
                  <div className="item-date flex items-center">
                    <Icon.CalendarBlank weight="bold" />
                ...
                <div className="bg-img mt-8">
                  <Image
                    ...
                    src={data?.img || "/images/blog/930x593.png"}
                    alt="img"
                  />
                </div>
              </div>
              <div className="paragraph-content mt-8">
                ...
                <div className="review pl-4 py-2 border-l-2 border-line mt-4">
                  <div className="body2 italic">
                    “ Seize control of your financial future and unleash your
                    potential for success. Our expert guidance will empower you
                    to navigate the intricacies of financial management. From
                    budgeting and saving to investing and debt management, we
                    provide the tools and knowledge you need to achieve your
                    goals.”.
                  </div>
                  <span className="text-xs uppercase font-bold mt-4">
                    Tony Nguyen, CEO of GGV
                  </span>
                </div>
              </div>
              ...
              <div className="paragraph-content mt-8">
                  ...
                  <div className="grid lg:grid-cols-2 gap-y-3">
                    <div className="w-full gap-y-3 flex flex-col">
                      ...
                      <div className="item flex items-center gap-3">
                        ...
                        />
                        <div className="text-button">
                          Management and calculation expenses
                        </div>
                      </div>
                    </div>
                    <div className="w-full gap-y-3 flex flex-col">
                ...
                <ul className="list-li mt-5 px-3">
                  <li className="body3 text-secondary">
                  ...
                  <li className="body3 text-secondary mt-2">
            ...
            {/* <div className="blog-more-infor mt-8">
              <div className="infor-above flex items-center justify-between flex-wrap gap-6">
                ...
                <div className="share-block flex items-center gap-4 max-sm:flex-wrap">
                  <div className="caption2 py-2 px-4 rounded-lg border border-line">
                    Copy the link
                  </div>
                  <div className="social-media flex items-center gap-3 max-sm:flex-wrap">
                    <a
                      ...
                      target="_blank"
                      className="w-10 h-10 flex items-center justify-center bg-surface rounded-full hover-box-shadow hover:bg-white duration-300"
                    >
                    ...
                    <a
                      ...
                      className="w-10 h-10 flex items-center justify-center bg-surface rounded-full hover-box-shadow hover:bg-white duration-300"
                    >
                      <i className="icon-twitter text-black text-sm"></i>
                    </a>
                    <a
                      ...
                      className="w-10 h-10 flex items-center justify-center bg-surface rounded-full hover-box-shadow hover:bg-white duration-300"
                    >
                      <i className="icon-insta text-black text-sm"></i>
                    </a>
                    <a
                      ...
                      className="w-10 h-10 flex items-center justify-center bg-surface rounded-full hover-box-shadow hover:bg-white duration-300"
                    >
                      <i className="icon-youtube text-black text-xs"></i>
                    </a>
                  </div>
                </div>
              </div>
              ...
              <form className="form-contact-input mt-6">
                <div className="grid sm:grid-cols-2 gap-5">
                  ...
                  <div className="w-full sm:col-span-2 flex items-center">
                    ...
                    <label htmlFor="check" className="caption1 pl-2">
                ...
                <div className="button-block mt-8">
                  <button className="button-main hover:bg-black bg-blue text-white text-button rounded-full">
                    Submit Comment
                  </button>
                </div>
              </form>
