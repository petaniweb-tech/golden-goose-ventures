...
interface ServiceDetailClientProps {
  foundPost: ServiceType | undefined;
}
          ...
          <div className="w-full xl:w-3/4">
            <div className="content-para xl:pr-[80px]">
              ...
              <div className="body2 text-secondary mt-4">
                ...
                financial management platform that provided users with a
                centralized dashboard for managing their finances. We wanted to
                create a platform that was user-friendly, easy to navigate, and
                offered a range of features to help users track their spending,
                monitor their investments, and plan for their financial future.
                Our goal was to provide users with the tools and resources they
                need to make informed financial decisions and achieve their
                financial goals.
              </div>
              ...
              <div className="body2 text-secondary mt-4">
                At our company, we offer a comprehensive suite of business
                services tailored to meet our clients&apos; unique needs and
                goals. Our services range from financial planning and accounting
                to marketing and brand management, delivered with exceptional
                value and expertise across various industries and business
                types. Our customized approach ensures that our solutions fit
                your specific objectives, whether you&apos;re a small startup or
