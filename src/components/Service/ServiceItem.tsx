      ...
      {style === "style-one" && (
        <div className="service-item p-8 bg-white rounded-lg border border-line hover-box-shadow">
          {/* <Link
            ...
            as={`/service/${data.category}`}
          > */}
          <div className="heading flex items-center justify-between">
            <i className={`${data.icon} text-brown md:text-6xl text-5xl`}></i>
            <div className="number heading3 text-placehover">{number + 1}</div>
          </div>
          <div className="heading6 hover:text-brown duration-300 mt-6">
            {data.title}
          </div>
      ...
      {style === "style-two" && (
        <div className="service-item py-7 px-6 bg-white rounded-lg border border-line box-shadow-sm hover-box-shadow">
          <Link
            ...
            href={`/${locale}/service/[category]`}
            as={`/${locale}/service/${data.category}`}
          >
            <div className="icon">
              <i className={`${data.icon} text-brown md:text-5xl text-4xl`}></i>
            </div>
            <div className="infor">
              <div className="heading7 hover:text-brown duration-300">
                {data.title}
              </div>
              <div className="text-secondary mt-2">{data.shortDesc}</div>
              <div className="read-more flex items-center gap-1 mt-2">
                <div className="text-button-sm">Explore Service</div>
                <Icon.CaretRight
                  weight="bold"
                  className="text-brown text-sm duration-300"
                />
              </div>
            </div>
          </Link>
      ...
      {style === "style-three" && (
        <div className="service-item px-8 py-10 bg-white rounded-lg">
          ...
          >
            ...
            ></i>
            <div className="heading7 text-center hover:text-brown duration-300 mt-6">
              {data.title}
            </div>
      ...
      {style === "style-four" && (
        <div className="service-item p-8 bg-white rounded-lg border border-line hover-box-shadow">
          ...
          >
            ...
            <div className="heading7 hover:text-brown duration-300 mt-6">
              {data.title}
            </div>
            <div className="text-secondary mt-2">{data.desc}</div>
            <div className="text-button-sm hover:text-brown underline inline-block duration-300 mt-3">
              Read More
            </div>
          </Link>
        </div>
      ...
      {style === "style-six" && (
        <div className="service-item rounded-2xl border border-line hover-box-shadow">
          ...
          >
            ...
            <div className="heading7 text-white hover:text-tan-light duration-300 mt-6">
              {data.title}
            </div>
